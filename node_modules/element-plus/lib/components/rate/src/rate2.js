  ...
  setup(__props, { expose, emit }) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        class: vue.normalizeClass(vue.unref(rateClasses)),
        role: "slider",
        ...
        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.max, (item, key) => {
          return vue.openBlock(), vue.createElementBlock("span", {
            ...
            style: vue.normalizeStyle({ cursor: vue.unref(rateDisabled) ? "auto" : "pointer" }),
            onMousemove: ($event) => setCurrentValue(item, $event),
            onMouseleave: resetCurrentValue,
            onClick: ($event) => selectValue(item)
          }, [
            vue.createVNode(vue.unref(index$2.ElIcon), {
              class: vue.normalizeClass([vue.unref(ns).e("icon"), { hover: hoverIndex.value === item }]),
