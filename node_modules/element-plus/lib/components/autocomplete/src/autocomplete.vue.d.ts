...
declare const _default: import("vue").DefineComponent<{
    ...
    readonly fetchSuggestions: import("element-plus/es/utils").BuildPropReturn<import("element-plus/es/utils").PropWrapper<(queryString: string, cb: (data: any[]) => void) => void>, () => void, unknown, unknown, unknown>;
